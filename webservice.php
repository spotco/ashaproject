...
function successFunct(data) {
	...
	for(var k = 0; k < data.array.length; k++ ) {
		...
		// Handle project photo - uses default if none is set. 
		var photoInfo;
...
// Change "slides" of information going forwards.
...
// Expand and collapse Youtube video
